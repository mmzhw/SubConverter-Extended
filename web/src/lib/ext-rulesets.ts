 ...
 *  or newlines) into rows, accepting both the canonical URL-parameter
 *  form (';') and the legacy textarea form ('\n'). Blank entries,
 *  '#'-prefixed entries, and entries without a comma are ignored;
