...
describe('parseSubUrl', () => {
  it('parses target, url and known options back into form state', () => {
    const { state } = parseSubUrl('http://host/sub?target=clashr&url=https%3A%2F%2Fsub.example.com%2F&filename=%E6%88%91%E7%9A%84%E8%AE%A2%E9%98%85&emoji=true&tfo=false&include=HK%7C%E9%A6%99%E6%B8%AF&interval=86400');
