export default {
  ...
  form: {
    ...
    rulePlacementAppend: 'End',
    rulePlacementPrepend: 'Top',
    rulePlacementPrependHint: 'Top rules head the final rule list, ahead of every rule from the remote config — including its private-network direct rules.',
  },
