export default {
  ...
  history: { title: '生成历史', local: '本地历史', serverShortLinks: '服务器短链', empty: '暂无生成记录', serverEmpty: '暂无服务器短链', clear: '清空', refresh: '刷新', delete: '删除', serverLoadFailed: '短链列表加载失败', createdAt: '创建', lastAccessAt: '访问' },
